...
ALTER TABLE member MODIFY create_date TIMESTAMP DEFAULT SYSTIMESTAMP;
ALTER TABLE notice MODIFY create_date TIMESTAMP DEFAULT SYSTIMESTAMP;
ALTER TABLE notice MODIFY update_date TIMESTAMP DEFAULT SYSTIMESTAMP;
...
ALTER TABLE point_charge ADD CONSTRAINT PK_POINT_CHARGE PRIMARY KEY (
                                                                     charge_id
    );
...
ALTER TABLE point_transfered ADD CONSTRAINT PK_POINT_TRANSFERED PRIMARY KEY (
                                                                             transfer_id
    );

ALTER TABLE prod_order ADD CONSTRAINT PK_ORDER PRIMARY KEY (
                                                       order_id
    );
...
ALTER TABLE userChat_rel ADD CONSTRAINT PK_USERCHAT_REL PRIMARY KEY (
                                                                     rel_id
    );
...
ALTER TABLE prod_img ADD CONSTRAINT PK_PROD_IMG PRIMARY KEY (
                                                             rel_id
    );

ALTER TABLE notic_img ADD CONSTRAINT PK_NOTIC_IMG PRIMARY KEY (
                                                               rel_id
    );

ALTER TABLE member ADD CONSTRAINT FK_image_TO_user_1 FOREIGN KEY (
                                                                img_id
    )
    REFERENCES image (
                      img_id
...
ALTER TABLE bid ADD CONSTRAINT FK_user_TO_bid_1 FOREIGN KEY (
                                                             bidder_id
    )
    REFERENCES member (
                     mem_id
...
ALTER TABLE point_charge ADD CONSTRAINT FK_point_TO_point_charge_1 FOREIGN KEY (
                                                                                charger_id
    )
    REFERENCES point (
                      mem_id
...
ALTER TABLE point_transfered ADD CONSTRAINT FK_point_TO_point_transfered_1 FOREIGN KEY (
                                                                                        sender_id
    )
    REFERENCES point (
                      mem_id
...
ALTER TABLE point_transfered ADD CONSTRAINT FK_point_TO_point_transfered_2 FOREIGN KEY (
                                                                                        receiver_id
    )
    REFERENCES point (
                      mem_id
...
ALTER TABLE prod_order ADD CONSTRAINT FK_point_transfered_TO_order_1 FOREIGN KEY (
                                                                             transfer_id
    )
...
ALTER TABLE prod_order ADD CONSTRAINT FK_product_TO_order_1 FOREIGN KEY (
                                                                    prod_id
    )
    REFERENCES product (
                        prod_id
...
ALTER TABLE prod_order ADD CONSTRAINT FK_product_TO_order_2 FOREIGN KEY (
                                                                    seller_id
    )
    REFERENCES member (
                        mem_id
...
ALTER TABLE prod_order ADD CONSTRAINT FK_user_TO_order_1 FOREIGN KEY (
                                                                 buyer_id
    )
    REFERENCES member (
                     mem_id
...
ALTER TABLE MSG ADD CONSTRAINT FK_chatroom_TO_MSG_1 FOREIGN KEY (
                                                                 chatr_id
    )
    REFERENCES chatroom (
                         chatr_id
...
ALTER TABLE userChat_rel ADD CONSTRAINT FK_chatroom_TO_userChat_rel_1 FOREIGN KEY (
                                                                                   chatr_id
    )
    REFERENCES chatroom (
                         chatr_id
...
ALTER TABLE userChat_rel ADD CONSTRAINT FK_user_TO_userChat_rel_1 FOREIGN KEY (
                                                                               user_id
    )
    REFERENCES member (
                     mem_id
...
ALTER TABLE prod_img ADD CONSTRAINT FK_image_TO_prod_img_1 FOREIGN KEY (
                                                                        img_id
    )
    REFERENCES image (
                      img_id
...
ALTER TABLE prod_img ADD CONSTRAINT FK_product_TO_prod_img_1 FOREIGN KEY (
                                                                          prod_id
    )
    REFERENCES product (
                        prod_id
...
ALTER TABLE notic_img ADD CONSTRAINT FK_notice_TO_notic_img_1 FOREIGN KEY (
                                                                           notic_id
    )
    REFERENCES notice (
                       notic_id
...
ALTER TABLE notic_img ADD CONSTRAINT FK_image_TO_notic_img_1 FOREIGN KEY (
                                                                          img_id
    )
    REFERENCES image (
                      img_id
...
ALTER TABLE member ADD CONSTRAINT unique_login_id UNIQUE (login_id);
ALTER TABLE member ADD CONSTRAINT unique_email UNIQUE (email);
ALTER TABLE product ADD CONSTRAINT chk_is_avaliable CHECK (is_avaliable IN (0, 1));
ALTER TABLE member ADD CONSTRAINT chk_auth CHECK (auth IN (0, 1));
ALTER TABLE notification ADD CONSTRAINT chk_is_read CHECK (is_read IN (0, 1));
ALTER TABLE MSG ADD CONSTRAINT MSG_chk_is_read CHECK (is_read IN (0, 1));
ALTER TABLE auction MODIFY (is_enabled NUMBER(1) DEFAULT 1);

ALTER TABLE point_transfered MODIFY (transfer_type NUMBER(1) DEFAULT 0);

ALTER TABLE product MODIFY (is_auction NUMBER(1) DEFAULT 0);
ALTER TABLE category MODIFY (super_category_id NUMBER(19) DEFAULT NULL);
ALTER TABLE notification MODIFY (is_read NUMBER(1) DEFAULT 0);
ALTER TABLE notice MODIFY is_activated DEFAULT 1;
ALTER TABLE product MODIFY is_avaliable DEFAULT 1;
ALTER TABLE product MODIFY prod_disc DEFAULT '';
ALTER TABLE point_charge MODIFY method DEFAULT NULL;
ALTER TABLE point_charge MODIFY transaction_id DEFAULT NULL;
ALTER TABLE auction MODIFY is_enabled DEFAULT 1;
ALTER TABLE member MODIFY address DEFAULT NULL;
ALTER TABLE member MODIFY img_id DEFAULT NULL;
ALTER TABLE member MODIFY auth DEFAULT 0;

-- user 테이블에 시퀀스를 디폴트값으로 설정
ALTER TABLE member MODIFY mem_id DEFAULT MEM_SEQ.NEXTVAL;

-- auction 테이블에 시퀀스를 디폴트값으로 설정
ALTER TABLE auction MODIFY prod_id DEFAULT auction_seq.NEXTVAL;

-- bid 테이블에 시퀀스를 디폴트값으로 설정
ALTER TABLE bid MODIFY bid_id DEFAULT bid_seq.NEXTVAL;

-- point_charge 테이블에 시퀀스를 디폴트값으로 설정
ALTER TABLE point_charge MODIFY charge_id DEFAULT point_charge_seq.NEXTVAL;

-- point 테이블에 시퀀스를 디폴트값으로 설정
ALTER TABLE point MODIFY mem_id DEFAULT point_seq.NEXTVAL;

-- point_transfered 테이블에 시퀀스를 디폴트값으로 설정
ALTER TABLE point_transfered MODIFY transfer_id DEFAULT point_transfered_seq.NEXTVAL;

-- order 테이블에 시퀀스를 디폴트값으로 설정
ALTER TABLE prod_order MODIFY order_id DEFAULT order_seq.NEXTVAL;

-- category 테이블에 시퀀스를 디폴트값으로 설정
ALTER TABLE category MODIFY category_id DEFAULT category_seq.NEXTVAL;

-- product 테이블에 시퀀스를 디폴트값으로 설정
ALTER TABLE product MODIFY prod_id DEFAULT product_seq.NEXTVAL;

-- delivery 테이블에 시퀀스를 디폴트값으로 설정
ALTER TABLE delivery MODIFY order_id DEFAULT delivery_seq.NEXTVAL;

-- notification 테이블에 시퀀스를 디폴트값으로 설정
ALTER TABLE notification MODIFY noti_id DEFAULT notification_seq.NEXTVAL;

-- notice 테이블에 시퀀스를 디폴트값으로 설정
ALTER TABLE notice MODIFY notic_id DEFAULT notice_seq.NEXTVAL;

-- chatroom 테이블에 시퀀스를 디폴트값으로 설정
ALTER TABLE chatroom MODIFY chatr_id DEFAULT chatroom_seq.NEXTVAL;

-- MSG 테이블에 시퀀스를 디폴트값으로 설정
ALTER TABLE MSG MODIFY chat_id DEFAULT msg_seq.NEXTVAL;

-- userChat_rel 테이블에 시퀀스를 디폴트값으로 설정
ALTER TABLE userChat_rel MODIFY rel_id DEFAULT userchat_rel_seq.NEXTVAL;

-- image 테이블에 시퀀스를 디폴트값으로 설정
ALTER TABLE image MODIFY img_id DEFAULT image_seq.NEXTVAL;

-- prod_img 테이블에 시퀀스를 디폴트값으로 설정
ALTER TABLE prod_img MODIFY rel_id DEFAULT prod_img_seq.NEXTVAL;

-- notic_img 테이블에 시퀀스를 디폴트값으로 설정
ALTER TABLE notic_img MODIFY rel_id DEFAULT notic_img_seq.NEXTVAL;
